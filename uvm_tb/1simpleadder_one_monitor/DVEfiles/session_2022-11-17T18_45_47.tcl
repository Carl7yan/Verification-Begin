...
# DVE full session
# Saved on Thu Nov 17 18:45:47 2022
# Designs open: 1
#   Sim: /home/icer/Desktop/fundamentals/verify/uvm_v/3simpleadder/simv
# Toplevel windows open: 1
# 	TopLevel.1
#   Source.1: uvm_pkg.\uvm_root::run_test 
#   Group count = 1
#   Group vif signal count = 6
...
#<Session mode="Full" path="/home/icer/Desktop/fundamentals/verify/uvm_v/3simpleadder/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state maximized -rect {{1 38} {1918 814}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 408} {height 499} {dock_state left} {dock_on_new_line true} {child_hier_colhier 288} {child_hier_coltype 118} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 105} {height 499} {dock_state left} {dock_on_new_line true} {child_data_colvariable 62} {child_data_colvalue 10} {child_data_coltype 10} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1917} {height 178} {dock_state bottom} {dock_on_new_line true}}
...
gui_set_env SIMSETUP::SIMARGS {{+v2k +notimingcheck +nospecify +vcs+flush+all -a compile.log -a run.log}}
gui_set_env SIMSETUP::SIMEXE {simv}
gui_set_env SIMSETUP::ALLOW_POLL {0}
if { ![gui_is_db_opened -db {/home/icer/Desktop/fundamentals/verify/uvm_v/3simpleadder/simv}] } {
gui_sim_run Ucli -exe simv -args { +v2k +notimingcheck +nospecify +vcs+flush+all -a compile.log -a run.log -ucligui} -dir /home/icer/Desktop/fundamentals/verify/uvm_v/3simpleadder -nosource
}
}
...
gui_sg_addsignal -group "$_session_group_1" { tb.vif.sig_clock tb.vif.sig_ina tb.vif.sig_inb tb.vif.sig_en_i tb.vif.sig_out tb.vif.sig_en_o }
...
catch {gui_list_select -id ${Hier.1} {tb.vif}}
...
gui_list_show_data -id ${Data.1} {tb.vif}
...
gui_open_source -id ${Source.1}  -replace -active {uvm_pkg.\uvm_root::run_test } /opt/uvm/uvm-1.2/src/base/uvm_root.svh
gui_view_scroll -id ${Source.1} -vertical -set 4473
